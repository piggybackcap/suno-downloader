...
```bash
# Single song (fast)
uv run python download_song_mp3.py <url-or-id> [-o downloads] [--start 1:30] [--end 2:45]

# Playlist
uv run python download_playlist_mp3.py <playlist-url-or-id> [-o downloads] [--flat]
```
